...
#ifndef CUTINFO_OCTREE_H
#define CUTINFO_OCTREE_H
...
protected:
  ...
  int index_;   ///< SklCellデータ領域内での格納開始インデックス
...
class CutPosOctreeTemplate : public CutPosOctree {
  ...
  CUT_POS* data_;   ///< SklCellデータ領域ポインタ
...
class CutBidOctreeTemplate : public CutBidOctree {
  ...
  CUT_BID* data_;   ///< SklCellデータ領域ポインタ
